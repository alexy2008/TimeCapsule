...
<section id="view-home" class="view active">
    <div class="hero-section">
        ...
        <div class="action-cards">
            <a href="/create" class="action-card cyber-glass action-card-link" aria-label="创建胶囊">
            ...
            <a href="/open" class="action-card cyber-glass action-card-link" aria-label="开启胶囊">
